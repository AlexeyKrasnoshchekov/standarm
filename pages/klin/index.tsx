    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.middleWrapper}>
        <div className={styles.left50}>
          ...
          <p className={styles.text}>
            В полностью открытом положении клиновой задвижки нижняя точка клина
            расположена выше проходного сечения трубопровода, что обеспечивает
            беспрепятственный проход рабочей среды, минимизирует потери рабочего
            давления, увеличивает эффективность транспортировки.
          </p>
        </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className={styles.cell}>
                ...
                МПа DN 50&divide;900 мм PN 16,0&divide;25,0 МПа DN 50&divide;600
                мм PN 42,0 МПа DN 50&divide;300 мм
              </td>
            </tr>
            <tr>
      ...
      <div className={styles.flex}>
        <div className={styles.left60}>
          ...
          <div className={styles.textWrapper}>
            <p className={styles.text}>
              ...
              особенно ценными для использования в магистральных трубопроводах,
              для которых характерно постоянное высокоскоростное движение
              рабочей среды.
            </p>
          </div>
        </div>
        <div className={styles.right40}>
          ...
          <p className={styles.text}>
            ...
            дополнительная опора под привод. Направление подачи среды - с любой
            стороны магистральных фланцев. Ограничительное кольцо
            устанавливается по требованию заказчика. Конструкция полнопроходной
            клиновой задвижки обеспечивает свободный проход механических
