  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div
        ...
        style={{ backgroundImage: `url("/images/ob_1.png")` }}
      >
        <P size="m" className={styles.text}>
          ...
          сточных вод промышленных предприятий и систем водоподготовки. Работая
          в данном направлении на протяжении более 10 лет, мы непрерывно
          совершенствовали предлагаемые технические решения и на сегодняшний
          день готовы выполнить весь комплекс работ необходимый для обеспечения
          производственных задач любой сложности от блочно-модульных установок
          для очистки малых объемов воды до строительства комплекса сооружений
          для сложных производственных задач.
        </P>
        <P size="m" className={styles.text}>
          Все очистные сооружения просты в монтаже и обслуживании, обеспечивают
          гарантированно стабильное качество очистки, а также высокую степень
          энергосбережения. Для проектных организаций мы разработали типовые
          решения, позволяющие сократить срок и стоимость разработки
          проектно-сметной документации и выполняющие все требования для
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.textInnerWrapper}>
          <p className={styles.text}>
            Качество нашей продукции и услуг должно соответствовать требованиям
            потребителей и превосходить их ожидания. Мы несём ответственность за
            наше оборудование от его подбора и разработки до монтажа и
            эксплуатации, обеспечиваем контроль качества на всех стадиях
            производства.
          </p>
        </div>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.textInnerWrapper}>
          <p className={styles.text}>
            ...
            биогенных элементов, тяжёлых металлов, галогенопроизводных, бактерий
            и пр., а также, в случае необходимости, добавления недостающих
            микроэлементов.
          </p>
        </div>
        <div className={styles.image}>
      ...
      <div className={styles.middleWrapper}>
        ...
        <div className={styles.right70}>
          <div className={styles.rightTextWrapper}>
            ...
            <p className={styles.text}>
              Потребление больших объемов технической воды – потребность многих
              современных предприятий. Постоянная водоподготовка и последующий
              сброс требует серьезных затрат, которые возникают в результате
              функционирования незамкнутой системы водоснабжения. Лучший способ
              экономично подготовить нужный объем технической жидкости –
              организовать систему оборотного водоснабжения (замкнутую систему
              водного хозяйства). Такая система предполагает повторную очистку
              технической воды после ее использования.
            </p>
          </div>
      ...
      <div className={styles.middleWrapper}>
        <div className={styles.left50}>
          <p className={styles.text}>
            На сегодняшний день, сложно найти источники воды пригодной для питья
            без предварительной очистки. Для решения этой проблемы разработаны и
            успешно внедряются станции очистки малозагрязненных природных вод –
            автоматизированные блочно-модульные станции водоподготовки. Станции
            специально разработаны для локальной очистки малозагрязненных
            природных вод от населенных пунктов численностью от 200 до 3200
            жителей, в местах, где подключение к действующим сетям не возможно
            или экономически не выгодно.
          </p>
          <p className={styles.text}>
            Очистные сооружения выпускаются с производства уже укомплектованные
            всем необходимым оборудованием, исходная вода может подаваться на
            очистку после монтажа станции на объекте и подключения к инженерным
            сетям.
          </p>
        </div>
        <div className={styles.right50}>
          ...
          <p className={styles.text}>
            ...
            фирменные очистные сооружения с обеспечением высоких показателей
            очистки воды.
          </p>
        </div>
      </div>
      ...
      <div>
        <div className={styles.inner}>
          <p className={styles.text}>
            ...
            всевозможных типов загрязнений возникает, если качество исследуемой
            воды не соответствует общепринятым регламентированным требованиям.
          </p>
        </div>
        ...
        <div className={styles.inner}>
          <p className={styles.text}>
            Выбор технологии для очистки ливневых, хозбытовых стоков, или стоков
            производств в первую очередь влияет на дальнейшие капитальные и
            эксплуатационные расходы предприятия. Расчет основных
            технико-экономических показателей процесса очистки позволит выбрать
        ...
        <div className={styles.inner}>
          <p className={styles.text}>
            ...
            используемой воды в канализационную сеть через санитарно-технические
            приборы. Сточные воды загрязняются физиологическими выделениями
            человека, бытовыми кухонными отбросами, домовым мусором.
          </p>
        </div>
        <div className={styles.innerWrapper}>
          ...
          <p className={styles.text}>
            ...
            решению и бюджету станции биологической очистки, которые работают по
            усовершенствованной классической технологии. Данная технология
            относится к способам биологической очистки стоков свободноплавающим
            активным илом, при которой качественная очистка достигается за счет
            создания равномерно распределенной технологической нагрузки в
            течении суток на все сооружения. Станции разработаны для локальной
            очистки сточных вод от населенных пунктов численностью от 80 до 4
            800 жителей. Усовершенствованная технология позволяет добиться
            стабильно высоких показателей очистки и повторно использовать
            очищенную воду в технических целях.
          </p>
        </div>
      </div>
      <div className={styles.innerWrapper}>
        <div className={styles.left70}>
          <p className={styles.text}>
            ...
            движения транспорта и пешеходов. Характер и концентрация загрязнений
            поверхностного стока изменяется в зависимости от вышеперечисленных
            факторов. Стоки содержат взвешенные вещества, органические вещества,
            нефтепродукты.
          </p>
          <p className={styles.text}>
            Для очистки поверхностных (ливневых, талых и промывных) сточных вод,
            мы предлагаем к внедрению станции двух типов: блочно-модульные и из
            стеклопластика. Данные станции применяются для очистки сточных вод
            до нормативов, предъявляемых к выпуску в рыбо-хозяйственные водоемы
            первой категории, от следующих видов загрязнений:
          </p>
          <ul className={styles.list}>
            <li>
              <span>{<FaChevronRight />}</span>
      ...
      <div className={styles.innerWrapper}>
        <div className={styles.left70}>
          ...
          <p className={styles.text}>
            ...
            помещённому в реактор. Прикрепленные микроорганизмы обладают большей
            концентрацией биомассы и большей активностью по сравнению с
      ...
      <div className={styles.innerWrapper}>
        ...
        <div className={styles.wrapper}>
          ...
          <p className={styles.text}>
            Локальные очистные сооружения на базе станций биохимической очистки
            IBR®-BM Станции IBR®-BM созданы для локальной очистки сложных
            коммунальных сточных вод и стоков с высоким содержанием азотных
            загрязнений ряда отраслей промышленности, например: пищевая
            промышленность; газоперерабатывающая промышленность; нефтехимическая
            промышленность; заводы по производству минеральных удобрений.
          </p>
        </div>
      </div>
      <div className={styles.titleWrapper}>
      ...
      <div style={{ display: 'flex', paddingTop: '2rem' }}>
        ...
        <div className={styles.middle40}>
          ...
          <p className={styles.text}>
            При грамотном инженерном подходе можно сократить эти затраты за счет
            организации оптимальной схемы оборотного водоснабжения,
          ...
          <p className={styles.text}>
            Мы предлагаем не просто решения по очистке промышленных сточных вод,
            а эффективные окупаемые бизнес-решения с учетом особенностей
