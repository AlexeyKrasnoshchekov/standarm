        ...
        <div className={styles.middleWrapper}>
          <div className={styles.left50}>
            <p className={styles.text}>
              ...
              надежного функционирования в условиях высоких температур и
              давлений, а также коррозионных сред. В то же время они обладают
              всеми преимуществами обычных дисковых затворов, такими как: малые
              габариты и масса, простота монтажа, автоматизации и иные функции.
            </p>
          </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={styles.cell}>
                  ...
                  ст. 08Х17Н13М2Т, ст. 10Х18Н9Л, ст. 12Х18Н12М3ТЛ , ст. 13ХМ ,
                  ст. 15ХМ , А352 LF2, А 352 LF3, А182 F316 , А182 F316L
                  INCONEL, MONEL , А216 WCB, А352 LCB, A351 CF3M, A351 CF3M, A
                  351 CF8, A351 CF8M
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className={styles.cell}>
                  -196°С &divide; +1000°С - широкий диапазон рабочих температур
                  в зависимости от применяемой марки стали
                </td>
              </tr>
              <tr>
                <td className={styles.cell}>
        ...
        <div className={styles.flex}>
          ...
          <div className={styles.right50}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <span>{<FaChevronRight />}</span>
                Корпус и диск изготавливаются из одного материала для
                обеспечения одинакового коэффициента температурного расширения.
              </li>
            </ul>
          </div>
        </div>
