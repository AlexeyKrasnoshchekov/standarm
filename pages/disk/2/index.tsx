      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.middleWrapper}>
          <div className={styles.left50}>
            ...
            <p className={styles.text}>
              Конструкция дискового затвора выполнена таким образом, что в
              отличие от шарового крана, запирание осуществляется за счет
              поджима диска к седлу в конечной точке поворота, при этом трение
              между диском и седлом присутствует лишь на протяжении 5...8
              градусов от общего угла поворота в момент закрытия и открытия
              дискового затвора. Это обеспечивает возможность длительной
              эксплуатации без повреждения уплотнения.
            </p>
          </div>
          ...
          <div className={styles.left33}>
            ...
            <ul className={styles.list}>
              <li>
                ...
                одновременно движется по направлению от посадочного кольца.
                Таким образом, уже при небольшой степени открытия он
                приподнимается с седла, за счет чего уплотнительное кольцо
                разгружается. Такая конструкция уменьшает износ уплотнения и
                снижает крутящий момент, благодаря чему затворы с двойным
                эксцентриком могут выдерживать свыше 100 000 циклов закрытия и
                открытия при сохранении герметичности.
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                Ремонтопригодность с возможностью легкой замены элементов
                уплотнений.
              </li>
            </ul>
          </div>
