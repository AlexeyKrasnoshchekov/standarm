...
function Kran4(): JSX.Element {
  return (
    <div className={styles.wrapper}>
      <h2 className={styles.title}>ШАРОВОЙ КРАН РАЗБОРНОЙ С ПЛАВАЮЩИМ ШАРОМ</h2>
      ...
      <div className={styles.linkOuterWrapper}>
        <div className={styles.linkWrapper}>
          ...
          <Link
            ...
            href={'/prod/kran_tl004.pdf'}
          >
            <a className={styles.link} target="_blank">
              Кран шаровой с плавающей пробкой Тип СТМ Ш 34
            </a>
          </Link>
        </div>
      </div>
        ...
        <table className={styles.table}>
          <tbody>
            <tr>
              ...
              <td className={styles.cell}>DN 50&divide;250 мм</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className={styles.cell}>
                PN 2,5&divide;4,0 МПа DN 15&divide;250 мм<br></br>
                PN 6,3&divide;10,0 МПа DN 15&divide;100 мм<br></br>
                PN 16&divide;25,0 МПа DN 15&divide;80 мм<br></br>
                PN 42,0 МПа DN 15&divide;50 мм
              </td>
            </tr>
            <tr>
...
export default withLayout(Kran4);
