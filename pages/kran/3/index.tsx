  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="КРАН ШАРОВОЙ С ПРОБКОЙ В ОПОРАХ ТИП СТМ Ш"
        />
        <title>КРАН ШАРОВОЙ С ПРОБКОЙ В ОПОРАХ ТИП СТМ Ш</title>
        <meta
          name="description"
        ...
        <div className={styles.linkOuterWrapper}>
          <div className={styles.linkWrapper}>
            ...
            <Link
              ...
              href={'/prod/kran_tl003.pdf'}
            >
              <a className={styles.link} target="_blank">
                Кран шаровой с пробкой в опорах Тип СТМ Ш 33
              </a>
            </Link>
          </div>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={styles.cell}>
                  ...
                  12Х2М1, ст. 12Х18Н12МЗТЛ , ст. 20Х2М1Л , ст. 20ХМЛ, ст.
                  20Х5МЛ, ст. 20Х8ВЛ, ст. 07X18Н9Л, БрА10Ж4Н4Л, БрАЖ 9-4, А350
                  LF2, А350 LF3, A105N, А182 F304, А182 F304L, А182 F316, А182
                  F316L, F11, F12, А105, F321, F347, F51, F53, F55, INCONEL,
                  MONEL, А216 WCB, А352 LCB, A217 WC6, A217 WC9, A217 C5, A217
                  C12, A351 CF3, A351 CF3M, A351 CF8, A351 CF8M, C95500, C61900,
                  4A, 5A
                </td>
              </tr>
              <tr>
        ...
        <div className={styles.flex}>
          ...
          <div className={styles.left33}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <span>{<FaChevronRight />}</span>
                Разборная, ремонтопригодная конструкция
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                Повышенный срок службы крана
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                Меньший по сравнению с другими конструкциями требуемый рабочий
                крутящий момент
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                Исполнение как с полным, так и неполным проходом
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                Присоединение к трубопроводу: во фланцевом исполнении с любым
                видом уплотнительной поверхности или сварное
              </li>
            </ul>
          </div>
        </div>
...
export default withLayout(Kran3);
