          ...
          <tbody>
            ...
            <tr>
              ...
              <td className={styles.cell}>
                ...
                12Х2М1, ст. 12Х18Н12МЗТЛ, ст. 20Х2М1Л, ст. 20ХМЛ ст. 20Х5МЛ, ст.
                20Х8ВЛ, ст. 07X18Н9Л, БрА10Ж4Н4Л, БрАЖ 9-4, А350 LF2, А 350 LF3,
                A105N, А182 F304, А182 F304L, А182 F316, А182 F316L, F11, F12,
                А105, F321, F347, F51, F53, F55, INCONEL, MONEL, А216 WCB, А352
                LCB, A217 WC6, A217 WC9, A217 C5, A217 C12, A351 CF3, A351 CF3M
                , A351 CF8, A351 CF8M, C95500, C61900, 4A, 5A
              </td>
            </tr>
            <tr>
      ...
      <div className={styles.flex}>
        ...
        <div className={styles.left33}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              <span>{<FaChevronRight />}</span>
              Сёдла в компоновке - одно седло с двойным эффектом поршня, другое
              седло с одинарным эффектом поршня
            </li>
            <li>
              <span>{<FaChevronRight />}</span>
        ...
        <div className={styles.left33}>
          ...
          <ul className={styles.list}>
            <li>
              <span>{<FaChevronRight />}</span>
              Герметичность до нулевой утечки обеспечивает мягкое уплотнительное
              кольцо седла.
            </li>
            <li>
              <span>{<FaChevronRight />}</span>
            ...
            <li>
              ...
              данной особой структуре корпус шарового крана и трубопровод имеют
