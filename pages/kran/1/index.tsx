...
function Kran1(): JSX.Element {
  return (
    <>
      <Head>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="keywords" content="РАН ШАРОВОЙ ЦЕЛЬНОСВАРНОЙ ТИП СТМ Ш" />
        <title>КРАН ШАРОВОЙ ЦЕЛЬНОСВАРНОЙ ТИП СТМ Ш</title>
        <meta
          name="description"
      ...
      <div className={styles.wrapper}>
        <h2 className={styles.title}>КРАН ШАРОВОЙ ЦЕЛЬНОСВАРНОЙ ТИП СТМ Ш</h2>
        ...
        <div className={styles.linkOuterWrapper}>
          <div className={styles.linkWrapper}>
            ...
            <Link
              ...
              href={'/prod/kran_tl001.pdf'}
            >
              <a className={styles.link} target="_blank">
                Кран шаровой цельносварной Тип СТМ Ш 31
              </a>
            </Link>
          </div>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={styles.cell}>
                  ст. 20, ст. 20Г , ст. 25Г, ст. ЗОГ, ст. 09Г2С, ст. 03Х18Н11 ,
                  ст. 03X18Н12, ст. 03Х18Н10Т, ст. 05Х18Н10Т, ст. 06Х18Н11, ст.
                  08X18Н10, от. 08X18НЮТ , ст. 08Х18Н12Т, ст. 08Х18Н12Б, ст.
                  ...
                  ст. 20Х8ВЛ, ст. 07X18Н9Л, БрА10Ж4Н4Л, БрАЖ 9-4, А350 LF2, А
                  350 LF3, A105N, А182 F304, А182 F304L, А182 F316, А182 F316L,
                  F11, F12, А105, F321, F347, F51, F53, F55, INCONEL, MONEL,
                  А216 WCB, А352 LCB, A217 WC6, A217 WC9, A217 C5, A217 C12,
                  A351 CF3, A351 CF3M , A351 CF8, A351 CF8M, C95500, C61900, 4A,
                  5A
                </td>
              </tr>
              <tr>
                ...
                <td className={styles.cell}>
                  PN 1,6&divide;10,0 МПа DN 50&divide;1500 мм<br></br>
                  PN 16,0 МПа DN 50&divide;1400 мм<br></br>
                  PN 25,0 МПа DN 50&divide;900 мм<br></br>
                  PN 42,0 МПа DN 50&divide;500 мм
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className={styles.cell}>
                  API 6D, API 608, ASME В16.34, ISO 17292, A SM E VIII
                </td>
              </tr>
              <tr>
        ...
        <div className={styles.flex}>
          <div className={styles.left33}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <span>{<FaChevronRight />}</span>
                Герметичность шарового крана в любом направлении потока
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
              ...
              <li>
                <span>{<FaChevronRight />}</span>
                Пожаробезопасная конструкция в соответствии с IS0 10497, API
                607, API 6FA.BS 6755-2
              </li>
            </ul>
          </div>
          ...
          <div className={styles.left33}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <span>{<FaChevronRight />}</span>
                Сёдла в компоновке - одно седло с двойным эффектом поршня,
          ...
          <div className={styles.left33}>
            ...
            <ul className={styles.list}>
              <li>
                <span>{<FaChevronRight />}</span>
                Герметичность до нулевой утечки обеспечивает мягкое
                уплотнительное кольцо седла.
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                Пружина седла шарового крана с предварительным натягом имеет
                хорошую адаптивность к изменению давления и температуры,
                предотвращает утечку.
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                Соответствие требованиям огнестойкости ГОСТ 30247.0-94, СТ ЦКБА
                001-2003, ISO 10497, API 607, API 6FA, BS 6755-2.
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                Передовая структура с опорной пластиной, повышающая срок службы
                шарового крана, уменьшающая рабочий крутящий момент.
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
                При открытии цельносварного шарового крана шар полностью
                охватывает седло так, что даже мелкие примеси рабочей среды не
                смогут разрушить седло и уплотнительную поверхность. Благодаря
                данной особой структуре корпус шарового крана и трубопровод
                имеют одинаковый срок службы.
              </li>
            </ul>
          </div>
        </div>
...
export default withLayout(Kran1);
