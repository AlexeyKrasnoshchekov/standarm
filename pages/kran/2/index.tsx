  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="КРАН ШАРОВОЙ СО СЪЁМНОЙ КРЫШКОЙ ТИП СТМ Ш"
        />
        <title>КРАН ШАРОВОЙ СО СЪЁМНОЙ КРЫШКОЙ ТИП СТМ Ш</title>
        <meta
          name="description"
          content="Шаровые краны со
              съемной крышкой позволяют повысить безопасность процесса и
              производительность установки. Корпус шарового крана имеет одну
              поверхность разъема, что уменьшает вероятность утечек рабочей
              среды."
        />
        ...
        <div className={styles.middleWrapper}>
          <div className={styles.left50}>
            <p className={styles.text}>
              ...
              производительность установки. Корпус шарового крана имеет одну
              поверхность разъема, что уменьшает вероятность утечек рабочей
              среды. Конструкция шарового крана может быть выполнена как с
              плавающим шаром, так и с пробкой в опорах
            </p>
          </div>
        ...
        <div className={styles.flex}>
          ...
          <div className={styles.left33}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <span>{<FaChevronRight />}</span>
                Возможность снять крышку для свободного доступа к полости
                корпуса без демонтажа крана с трубопровода.
              </li>
              <li>
                <span>{<FaChevronRight />}</span>
              ...
              <li>
                <span>{<FaChevronRight />}</span>
                Присоединение к трубопроводу в зависимости от технологии
                возможно во фланцевом исполнении с любым видом уплотнительной
                поверхности или сварное.
              </li>
            </ul>
          </div>
        </div>
